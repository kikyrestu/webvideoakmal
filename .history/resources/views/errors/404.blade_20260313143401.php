...
<head>
    ...
    <title>404 — Halaman Tidak Ditemukan | {{ setting('site_name', 'Video Portal') }}</title>
    @vite(['resources/css/app.css'])
</head>
<body style="display:flex;align-items:center;justify-content:center;min-height:100vh;background:#111;">
    <div style="text-align:center;padding:40px 20px;">
        <div style="font-size:96px;font-weight:900;color:#222;line-height:1;margin-bottom:8px;">404</div>
        <h1 style="font-size:22px;font-weight:700;color:#e5e5e5;margin-bottom:10px;">Halaman Tidak Ditemukan</h1>
        <p style="color:#555;font-size:14px;margin-bottom:28px;">Halaman yang kamu cari tidak ada atau sudah dihapus.</p>
        <a href="/"
