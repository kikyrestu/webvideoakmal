...
<nav class="nav-tabs-bar">
    <div class="nav-tabs-inner">
        <a href="/" class="nav-tab {{ request()->is('/') && !request('filter') ? 'active' : '' }}">
            <svg fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" style="width:15px;height:15px;">
