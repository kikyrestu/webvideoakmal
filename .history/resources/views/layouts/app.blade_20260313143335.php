...
<head>
    ...
    @php
        ...
        $metaDesc  = trim(View::yieldContent('description')) ?: setting('site_description', 'Portal video online');
        $metaImg   = trim(View::yieldContent('og_image')) ?: (setting('site_logo') ? Storage::url(setting('site_logo')) : '');
