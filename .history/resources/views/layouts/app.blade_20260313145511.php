...
<head>
    ...
    <meta name="description" content="@hasSection('description')@yield('description')@else{{ $siteDesc }}@endif">
    <link rel="canonical" href="{{ url()->current() }}">

    {{-- Open Graph --}}
    <meta property="og:site_name"   content="{{ $siteName }}">
    <meta property="og:title"       content="@hasSection('title')@yield('title') — {{ $siteName }}@else{{ $siteName }}@endif">
    <meta property="og:description" content="@hasSection('description')@yield('description')@else{{ $siteDesc }}@endif">
    ...
    <meta name="twitter:description" content="@hasSection('description')@yield('description')@else{{ $siteDesc }}@endif">
    @hasSection('og_image')
