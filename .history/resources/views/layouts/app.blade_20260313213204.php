...
<head>
    ...
    @php
        ...
        $siteImg   = $logoPath ? Storage::url($logoPath) : '';

        // SEO per halaman — pakai View::hasSection() yg valid di dalam @php
        $pageTitle  = View::hasSection('title')       ? View::yieldContent('title')       : '';
        $pageDesc   = View::hasSection('description') ? View::yieldContent('description') : '';
        $pageImg    = View::hasSection('og_image')    ? View::yieldContent('og_image')    : '';
        $pageType   = View::hasSection('og_type')     ? View::yieldContent('og_type')     : 'website';

        $fullTitle  = $pageTitle  ? "$pageTitle — $siteName" : $siteName;
        $metaDesc   = $pageDesc   ?: $siteDesc;
        $metaImg    = $pageImg    ?: $siteImg;
    @endphp
