...
@section('title', $video->title . ' — ' . setting('site_name', 'Video Portal'))
    ...
    <div class="video-info-section">
        ...
        <div class="video-meta-row">
            ...
            <div class="video-actions" x-data="{
                ...
                {{-- Embed Button --}}
                <button class="action-btn" @click="showEmbed = true">
                    <svg fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                ...
                {{-- Embed Modal --}}
                <div x-show="showEmbed" class="modal-overlay" @click.self="showEmbed = false" x-cloak>
                    <div class="modal-box">
                        <h3>Embed Video</h3>
                        <p style="font-size:13px;color:#aaa;margin-bottom:12px;">Salin kode berikut untuk embed video ini di website Anda:</p>
                        <div class="modal-code">{{ $video->getEmbedCode() }}</div>
                        <button class="btn-primary" style="margin-top:16px;" @click="navigator.clipboard.writeText('{{ $video->getEmbedCode() }}')">Salin Kode</button>
                        <button class="action-btn" style="margin-top:12px;margin-left:8px;" @click="showEmbed = false">Tutup</button>
                    </div>
                </div>
            </div>
        </div>
